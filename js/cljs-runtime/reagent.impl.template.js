...
var G__22432 = o;
reagent.impl.template.goog$module$goog$object.set(G__22432,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22495__i = 0, G__22495__a = new Array(arguments.length -  0);
while (G__22495__i < G__22495__a.length) {G__22495__a[G__22495__i] = arguments[G__22495__i + 0]; ++G__22495__i;}
  args = new cljs.core.IndexedSeq(G__22495__a,0,null);
} 
...
var G__22437 = o;
reagent.impl.template.goog$module$goog$object.set(G__22437,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22438__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22446 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22446,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22446;
}
})(),id_class);
...
var temp__5823__auto___22510 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___22510)){
var d_22512 = temp__5823__auto___22510;
...
var G__22451 = (cljs.core.count(argv) - first_child);
switch (G__22451) {
case (0):
...
var vec__22466 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22466,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22466,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22466,(2),null);
...
var temp__5827__auto___22518 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22518 == null)){
} else {
var key_22519 = temp__5827__auto___22518;
...
var temp__5827__auto___22520 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22520 == null)){
} else {
var key_22521 = temp__5827__auto___22520;
(jsprops.key = key_22521);
}
...
var temp__5827__auto___22522 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___22522 == null)){
} else {
var key_22523 = temp__5827__auto___22522;
(jsprops.key = key_22523);
}
...
var temp__5827__auto___22536 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22536 == null)){
} else {
var key_22537 = temp__5827__auto___22536;
(jsprops.key = key_22537);
}
...
var temp__5827__auto___22538 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22538 == null)){
} else {
var key_22539 = temp__5827__auto___22538;
(jsprops.key = key_22539);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22470_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22470_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22474 = reagent.ratom.check_derefs((function (){
...
break;
default:
var G__22545 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22546 = compiler;
v = G__22545;
compiler = G__22546;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22491 = (function (opts,id,fn_to_element,parse_fn,meta22492){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22491.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22493,meta22492__$1){
var self__ = this;
var _22493__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22491(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22492__$1));
}));

(reagent.impl.template.t_reagent$impl$template22491.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22493){
var self__ = this;
var _22493__$1 = this;
return self__.meta22492;
}));

(reagent.impl.template.t_reagent$impl$template22491.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22491.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22491.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22491.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22491.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22491.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22492","meta22492",-2090122307,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22491.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22491.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22491");

(reagent.impl.template.t_reagent$impl$template22491.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22491");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22491.
 */
reagent.impl.template.__GT_t_reagent$impl$template22491 = (function reagent$impl$template$__GT_t_reagent$impl$template22491(opts,id,fn_to_element,parse_fn,meta22492){
return (new reagent.impl.template.t_reagent$impl$template22491(opts,id,fn_to_element,parse_fn,meta22492));
});
...
return (new reagent.impl.template.t_reagent$impl$template22491(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
